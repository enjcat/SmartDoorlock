...
"\n"\
"function initCanvas() {\n"\
"    var canvas = document.getElementById(\"canvas-QQ-VGA\");\n"\
...
"       ln = 0;        \n"\
"       var scaled = scaleImageData(imgData, 5);\n"\
...
"    if (canvasid.indexOf(\"canvas-QQ-VGA\", 0) != -1) {\n"\
"        xres = 160;\n"\
"        yres = 120;\n"\
"    }\n"\
"    \n"\
...
"</div>\n"\
"\n"\
"<center> <h1> SmartDoorlock </h1> </center>\n"\
"\n"\
"\n"\
"<table align=center valign=center id=\"canvas7670\">\n"\
"    <tr> \n"\
"        <td valign=\"bottom\">    \n"\
"<canvas id=\"canvas-QQ-VGA\" width=\"800\" height=\"600\" style=\"cursor:crosshair;border:1px solid #FFFF00;\" >\n"\
